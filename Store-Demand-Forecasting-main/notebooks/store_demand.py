...
_data_dir = os.path.join(_script_dir, '..', 'src', 'data')

train = pd.read_csv(os.path.join(_data_dir, 'train.csv'), parse_dates=['date'])
test = pd.read_csv(os.path.join(_data_dir, 'test.csv'), parse_dates=['date'])
...
plt.savefig(os.path.join(_script_dir, 'forecast_store1_item1.png'), dpi=100, bbox_inches='tight')
print(f"\nSaved: {os.path.join(_script_dir, 'forecast_store1_item1.png')}")
plt.close()
...
plt.figure(figsize=(20,9))
train[(train.store == 1) & (train.item == 17)].set_index("date").sales.plot(legend=True, label = "Store 1 Item 17 Sales")
...
plt.savefig(os.path.join(_script_dir, 'forecast_store1_item17.png'), dpi=100, bbox_inches='tight')
print(f"Saved: {os.path.join(_script_dir, 'forecast_store1_item17.png')}")
plt.close()
